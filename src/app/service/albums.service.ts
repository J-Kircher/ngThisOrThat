...
const _ALBUMS: IAlbum[] = [
  ...
  { 'artist': 'Nick Drake', 'title': 'Pink Moon', 'year': 1972, 'image': 'DrakePinkMoon' },
  ...
  { 'artist': 'The Velvet Underground', 'title': 'The Velvet Underground & Nico', 'year': 1967, 'image': 'VU&Nico' },
  ...
  { 'artist': 'Jethro Tull', 'title': 'Aqualung', 'year': 1971, 'image': 'JethroTullAqualung' },
  { 'artist': 'Neutral Milk Hotel', 'title': 'In the Aeroplane Over the Sea', 'year': 1998, 'image': 'NMHAeroplane' },
  { 'artist': 'Buddy Holly', 'title': 'Greatest Hits', 'year': 1996, 'image': 'HollyGreatestHits' },
];
